...
帮助用户基于akshare数据源进行A股模拟盘选股，使用5大规则筛选当日尾盘可关注的潜在标的。

## 选股逻辑（5大规则）

1. **K线上扬趋势** - 当前价 > MA5 > MA10 > MA20
2. **近期强势表现** - 10个交易日内有涨停记录
3. **板块共振效应** - 所属板块当日有3只以上涨停股票
4. **大盘环境判断** - 上证指数技术面分析（MA5与MA10对比）
5. **基本面预留** - 财报数据接口（待扩展）
...
💡 模拟盘重点关注
- 开山股份(300257) - 10日内3次涨停，通用设备板块龙头
- 欧科亿(688308) - 2次涨停，均线多头排列标准

⚠️ 注意：大盘今日MA5 < MA10，偏弱，尾盘操作需谨慎
```
